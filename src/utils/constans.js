module.exports = {
  ...
  selectTypes: {
    ...
    orderForCompanies: 'state points order_description take_address deliver_address order_start_time order_end_time receiver_name receiver_phone comment userId rating createdTime',
    orderForActiveOrders: 'state points order_description take_address deliver_address order_start_time order_end_time receiver_name receiver_phone comment companyId rating createdTime',
